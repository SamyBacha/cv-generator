# Capability: cv-data-persistence

## Purpose

Persist CV data across browser sessions using `localStorage`, so that edits and uploaded data survive page reloads. Also ensures the default embedded CV data contains no real personal information.
